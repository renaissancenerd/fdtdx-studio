...
class Export:
	...
	def build_Volume(self, Volume: fdtdx.SimulationVolume):
		...
		return {
			...
			"partial_real_shape": {
				"__module__": "builtins", "__name__": "tuple",
	...
	def build_source(self, obj):
		...
		ret.update({
			...
			"max_random_grid_offsets": {
				"__module__": "builtins", "__name__": "tuple", "__value__": obj.max_random_grid_offsets
			},
			"max_random_real_offsets": {
				"__module__": "builtins", "__name__": "tuple", "__value__": obj.max_random_real_offsets
			},
			"max_vertical_offset": obj.max_vertical_offset,
			"name": obj.name,
			"partial_grid_shape": {
				"__module__": "builtins", "__name__": "tuple", "__value__": obj.partial_grid_shape
			},
			"partial_real_shape": {
				"__module__": "builtins", "__name__": "tuple", "__value__": obj.partial_real_shape
			},
		...
		ret.update({
			...
			"partial_real_position": {
				"__module__": "builtins", "__name__": "tuple", "__value__": obj.partial_real_position
			}
		})
		return ret
	...
	def build_detector(self, obj):
		...
		match types:
			...
			case _:
				result.update({"if_inverse_plot_backwards": obj.if_inverse_plot_backwards,
											"inverse": obj.inverse})
	
		result.update({"max_random_grid_offsets": {
											"__module__": "builtins",
											"__name__": "tuple",
												"__value__":
													obj.max_random_grid_offsets
											},
											"max_random_real_offsets": {
												"__module__": "builtins",
												"__name__": "tuple",
			...
			case fdtdx.PositionConstraint:
				result.update({
					...
					"margins":{
						"__module__": "builtins",
						"__name__": "tuple",
						"__value__": obj.margins
					},
					"grid_margins": {
						"__module__": "builtins",
						"__name__": "tuple",
						"__value__": obj.grid_margins
					}
				})
			case fdtdx.SizeConstraint:
				result.update({
					...
					"other_axes": {
						"__module__": "builtins",
						"__name__": "tuple",
						"__value__": obj.other_axes
					},
					"proportions":{
						"__module__": "builtins",
						"__name__": "tuple",
						"__value__": obj.proportions
					},
					"offsets":{
						"__module__": "builtins",
						"__name__": "tuple",
						"__value__": obj.offsets
					},
					"grid_offsets":{
						"__module__": "builtins",
						"__name__": "tuple",
						"__value__": obj.grid_offsets
					}
				})
